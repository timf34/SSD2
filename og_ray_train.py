...
from algos.new_ppo_baseline import build_ppo_baseline_trainer
from social_dilemmas.config.default_args import add_default_args
from social_dilemmas.envs.env_creator import get_env_creator
from utils.utility_funcs import update_nested_dict
...
def build_experiment_config_dict(args):
    ...
    if args.algorithm == "PPO":
        ...
        sys.exit("The only available algos are A3C, PPO and IMPALA")
